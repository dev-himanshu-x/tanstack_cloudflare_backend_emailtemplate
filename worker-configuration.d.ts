/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b62368bf3abeecac78c2e34c5233eb2f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DB_FILE_NAME">> {}
}
